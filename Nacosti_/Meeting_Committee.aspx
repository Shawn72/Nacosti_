<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Meeting_Committee.aspx.cs" Inherits="Nacosti_.Meeting_Committee" MasterPageFile="~/Site.Master" %>
        ...
        <div class="content container-fluid">
            ...
            <div class="panel panel-default" style="margin-top:10px;" >
                <%
                    ...
                    var meetingDetails = odataconn.committeeMeetings.Where(r => r.No == meetingCode).ToList().OrderByDescending(m=>m.Start_date);
                                ...
                                <div class="mb-3">
                                    ...
                                    <asp:TextBox runat="server" placeholder="please input your comment here" TextMode="MultiLine" ID="txtareaComment"
                                         CssClass="form-control" style="width: 100%; height: 100px; font-size: 14px; line-height: 15px; border: 1px solid #dddddd; padding: 10px;" MaxLength="10"
                                                 onKeyUp="javascript:CheckTextArea(this, 250);" onChange="javascript:CheckTextArea(this, 100);">
                                    </asp:TextBox>
                                </div>
                                <br/>
                                <div class="row">
